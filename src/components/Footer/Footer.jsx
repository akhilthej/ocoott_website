...
import footer_csd from './csdv2Logofooter.png';
      ...
      <section className="bg-black pb-5">
        <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-9 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="max-w-xs mt-4 text-sm text-gray-600">
                We are a web development and design company with a mission to help businesses establish an online presence.
                We achieve this by continually developing technology, offering expert support, and ensuring a seamless online experience.
              </p>
          ...
          <p className="cursor-default text-center text-xs text-white">
            2023 © OTT.in <br/>{/*Designed and Developed by CyberSpaceDigital(www.cyberspacedigital.in) */}
