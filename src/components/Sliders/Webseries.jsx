...
import {WebSeriesMoviesData} from '../DATA/MoviesData';
...
const WebSeries = () => {
  ...
  return (
    <div className='my-5'>
    <h1 className='pl-5 pb-2 cursor-default  text-2xl md:text-4xl fade-in-down font-bold text-white tracking-tight'>Web Series</h1>
      <Slider {...settings}>
        {WebSeriesMoviesData.map((image) => (
          <div key={image.id}>
